      ...
      <div className="space-y-4 py-4 h-full flex flex-col">
        <div className="px-4 py-2 bg-[#121212] rounded-lg mb-2 mx-2">
          <div className="space-y-1">
             ...
             <Button variant="ghost" className="w-full justify-start font-bold text-zinc-400 hover:text-white hover:bg-transparent pl-0 text-base transition-colors duration-200">
                <svg role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" className="mr-4 fill-current"><path d="M10.533 1.27893C5.35215 3.2056 1.28974 7.31507 1.00514 12.9536L1.00297 13H1C1 19.0751 5.92487 24 12 24C18.0751 24 23 19.0751 23 13H22.997C22.7124 7.31507 18.65 3.2056 13.4691 1.27893L12 0.72833L10.533 1.27893ZM2.99999 15C3.00266 9.36518 6.36271 4.70522 11.6354 2.75165C11.7532 2.70799 11.8766 2.68603 12 2.68603C12.1234 2.68603 12.2468 2.70799 12.3646 2.75165C17.6373 4.70522 20.9973 9.36518 21 15H15C15 16.6569 13.6569 18 12 18C10.3431 18 9 16.6569 9 15H2.99999Z"></path></svg>
                Search
             </Button>
          </div>
        </div>
        <div className="py-2 flex-1 flex flex-col bg-[#121212] rounded-lg mx-2">
          <div className="px-4 pt-4 flex items-center justify-between">
            <Button variant="ghost" className="justify-start font-bold text-zinc-400 hover:text-white hover:bg-transparent pl-0 text-base group">
          ...
          <div className="px-4 py-2 flex gap-2 overflow-x-auto no-scrollbar">
              <span className="px-3 py-1 bg-[#2a2a2a] rounded-full text-sm text-white cursor-pointer hover:bg-[#3a3a3a] transition-colors whitespace-nowrap">Playlists</span>
              <span className="px-3 py-1 bg-[#2a2a2a] rounded-full text-sm text-white cursor-pointer hover:bg-[#3a3a3a] transition-colors whitespace-nowrap">Projects</span>
          </div>
            ...
            <div className="space-y-1 p-2">
               <Button variant="ghost" className="w-full justify-start font-normal text-zinc-400 hover:text-white hover:bg-[#1a1a1a] h-16">
                   ...
                   <div className="flex flex-col items-start overflow-hidden">
                      <span className="text-white font-medium truncate w-full">Liked Songs</span>
                      <span className="text-xs text-zinc-400 flex items-center">
                         <span className="text-green-500 -rotate-45 mr-1">📌</span> Playlist • 123 songs
                      </span>
                   </div>
               </Button>
               {projectCategories.map((category) => (
                 <Button
                   ...
                   variant="ghost"
                   className={cn(
                     "w-full justify-start font-normal text-zinc-400 hover:text-white hover:bg-[#1a1a1a] h-16",
                     selectedCategoryId === category.id && "bg-[#1a1a1a] text-white"
                   )}
